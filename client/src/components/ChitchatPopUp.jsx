...
<div className="d-flex justify-content-center w-100">
                        ...
                        <Modal
                            ...
                            <div className="fade-in card border-0 ">
                                ...
                                <div className="d-flex justify-content-center align-items-center">
                                    {/* <button className='btn my-3 w-25 rounded-pill' onClick={closeModalEnterChat} style={{position: 'fixed', bottom: "20%", backgroundColor: "rgb(47 124 49 / 20%)"}}>Chat</button> */}
                                    <button className='btn btn-outline-warning my-3 w-25 rounded-pill' onClick={closeModalEnterChat} style={{position: 'fixed', bottom: "20%"}}>Chat</button>
                                </div>
                            </div>
                        </div>
