...
const GuestEventList = ({events}) => {
    ...
    useEffect(() => {
        ...
        // console.log("running GuestEventList useEffect")
                        ...
                        <div className="card-header">
                            <div className="d-flex align-items-center justify-content-between">
                                <div className="event-name live-search-list">
                                    <p onClick={() => navigate(`/guests/events/${event._id}`)} className="text-primary h5 " style={{cursor : "pointer"}}>{event.name}</p>
                                </div>
