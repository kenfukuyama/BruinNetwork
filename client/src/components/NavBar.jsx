                        ...
                        <li className="nav-item ps-2">
                            <div className="btn-group">
                                ...
                                <ul className="dropdown-menu" style={{backgroundColor : "#000"}}>
                                    ...
                                    <li><Link className="btn text-white" to={"/myevents/posted/calendar"}><i className="bi bi-person-lines-fill nav-icon"></i> My Events</Link></li>
...
{/* 
                        ...
                        <ul className="navbar-nav ms-auto bg-sm-transparent">
                            <li className="nav-item ps-2">
                                <Link className="nav-link text-white" to={"/login"} onClick={() => {mobileButtonRef.current.click();}}><i className="bi bi-door-open-fill nav-icon"></i> LOGIN</Link>
                            </li>
                            <li className="nav-item ps-2">
                                <Link className="nav-link text-white" to={"/register"} onClick={() => {mobileButtonRef.current.click();}}><i className="bi bi-people-fill nav-icon"></i> REGISTER</Link>
                            </li>
                        </ul>
