...
const GuestEvents = () => {
    ...
    return (
        ...
        <div className="vh-100">
            ...
            <div className="container py-5 h-100" style={{position: "absolute"}}>
                <div className="row d-flex justify-content-center align-items-center h-100">
                    ...
                    {!events || loading ?
                            ...
                            <div className="fade-in card bg-transparent scroll-box" style={{ borderRadius: "15px", backgroundColor: "#ffffff", overflowY : "scroll" , height: "93vh"}}>
                                ...
                                {events && <GuestEventList events={events} />}
                            </div>
                    }
                    
                    </div>
                </div>
            <Link className="chatrooms-submit text-wrap btn btn-lg w-sm-75 w-md-50 w-lg-25 w-xl-25 w-xxl-25 text-white" style={{position : "relative", bottom: "5%", zIndex: "1000"}} to={"/guests/chatrooms"}><strong>See Chatrooms</strong> <i className="bi-arrow-right-short"></i></Link>
            </div>
        </div>
    )
}
