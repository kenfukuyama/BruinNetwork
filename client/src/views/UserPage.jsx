                                ...
                                <div className="card-body p-4 text-black">
                                    ...
                                    <div className="d-flex align-items-center justify-content-between">
...

                                        {
                                            ...
                                            <div className="d-flex h5 align-items-center justify-content-center gap-2 btn" onClick={(e) => {window.location.replace(`https://www.instagram.com/${user.current.instagramUsername}`)}}>
