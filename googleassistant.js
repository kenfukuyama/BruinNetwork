...
//                 }
//                 else {
//                     console.log("Ummm I have troubling, maybe say something else...")
//                 }
//                 promptUser();
//             });
//     });
...
//     console.log("running get response...");
//     assistant.assist(prompt)
//         .then(({ text }) => {
//             if (text) {
//                 console.log(text); 
...
//             else {
//                 console.log("Ummm I have troubling, maybe say something else...");
//                 return "Ummm I have troubling, maybe say something else...";
//             }
//         })
//         .catch(err => {
//             return "Something is off trying to get a response";

//         });
// };
// // promptUser();
// // getResponse("Tell me a joke");
// module.exports = {promptUser, getResponse, GoogleAssistant};
